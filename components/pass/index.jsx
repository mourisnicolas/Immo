  ...
  return (
    <>
      <span className={styles.formTitlePass}>
        <img onClick={removeChange} className={styles.arrow} src="/icn_arrow_left.svg" />
      ...
      <span className={`${styles.backMess} ${styles.backTwo}`}><img src='/icn_lock.svg'/> <span className={styles.backMessText}>Diese Verbindung ist sicher.</span></span>
      </>
  )
}
